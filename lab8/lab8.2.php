...
class CalculatorV{
    public function mostrarFormulario() {
        echo '<h1>Calculadora Factorial</h1>';
        echo '<form method="POST">';
        echo '<label for="numero">Ingrese un número deseado:</label>';
    ...
    public function mostrarResultado($resultado) {
        echo '<h1>Resultado Factorial</h1>';
        echo "<p>$resultado</p>";
...
$model = new FactorialCalculator();
$view = new CalculatorV();
